...
# Takes Dataframe as input and returns NaNs for each column. Output:
# Pandas Series


def df_nulls(df):
    print(
        f'Number of null values in each column is: \n
...
# Splits a datetime column into its day, month and year columns
# returns the dataframe after dropping original datetime column
